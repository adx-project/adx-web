    ...
    <div class="container">
      <div class="row content">
        <div class="col-12 data-policy">
          ...
          Welcome to ADX (“Company”, “we”, “our”, “us”)!

          These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at
          www.adxproject.org (together or individually “Service”) operated by ADX.
          ...
          let us know by emailing at hello@adxproject.org so we can try to find a solution. These Terms apply to all
          ...
          by following the unsubscribe link or by emailing at hello@adxproject.org.
          ...
          <h1>4. Content</h1>
          Content found on or through this Service are the property of ADX or used with permission. You may not
          ...
          <ol>
            ...
            <li>To engage in any other conduct that restricts or inhibits anyone’s use or enjoyment of Service, or
          ...
          <ol>
            <li>Use Service in any manner that could disable, overburden, damage, or impair Service or
          ...
          will remain the exclusive property of ADX and its licensors. Service is protected by copyright, trademark,
          and other laws of and foreign countries. Our trademarks may not be used in connection with any product or
          service without the prior written consent of ADX.

          <h1>9. Copyright Policy</h1>
          ...
          hello@adxproject.org, with the subject line: “Copyright Infringement” and include in your claim a detailed
          ...
          <h1>10. DMCA Notice and Procedure for Copyright Infringement Claims</h1>
          ...
          <ol>
            ...
            <li>identification of the URL or other specific location on Service where the material that you claim is
            ...
            <li>a statement by you, made under penalty of perjury, that the above information in your notice is
              ...
              You can contact our Copyright Agent via email at hello@adxproject.org.
            </li>
          </ol>

          <h1>11. Error Reporting and Feedback</h1>
          You may provide us either directly at hello@adxproject.org or via third party sites and tools with
          information and feedback concerning errors, suggestions for improvements, ideas, problems, complaints, and
          other matters related to our Service (“Feedback”). You acknowledge and agree that: (i) you shall not retain,
          acquire or assert any intellectual property right or other right, title or interest in or to the Feedback;
          ...
          <h1>12. Links To Other Web Sites</h1>
          Our Service may contain links to third party web sites or services that are not owned or controlled by ADX.

          ADX has no control over, and assumes no responsibility for the content, privacy policies, or practices of
          ...
          <h1>13. Disclaimer Of Warranty</h1>
          ...
          These Terms shall be governed and construed in accordance with the laws of France, which governing law
          ...
          <h1>19. Waiver And Severability</h1>
          ...
          <h1>20. Acknowledgement</h1>
          BY USING SERVICE OR OTHER SERVICES PROVIDED BY US, YOU ACKNOWLEDGE THAT YOU HAVE READ THESE TERMS OF SERVICE
          AND AGREE TO BE BOUND BY THEM.

          <h1>21. Contact Us</h1>
          Please send your feedback, comments, requests for technical support by email: hello@adxproject.org.
